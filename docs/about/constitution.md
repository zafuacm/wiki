...
2. 实验室座位使用在线表格管理，分别为：[实验室座位表](https://docs.qq.com/sheet/DYk9sbXl4VEpYV2lZ) 和 [座位变动记录表](https://docs.qq.com/sheet/DYnZ1b2NsdkxrWFBn)。
...
队员在确认需要的位置后，填写座位变动记录表，并在座位表上对应位置做好标记即可。

**第三条** 座位使用规则。

1. 当座位情况不足时，将清理不活跃的固定座位，释放给流动座位。
