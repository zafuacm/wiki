import{_ as n,c as a,P as l,o as p}from"./chunks/framework.BGjoKjVW.js";const d=JSON.parse('{"title":"MkDocs","description":"","frontmatter":{"comments":true},"headers":[],"relativePath":"other/mkdocs.md","filePath":"other/mkdocs.md","lastUpdated":1737212926000}'),o={name:"other/mkdocs.md"};function e(t,s,c,r,i,E){return p(),a("div",null,s[0]||(s[0]=[l(`<h1 id="mkdocs" tabindex="-1">MkDocs <a class="header-anchor" href="#mkdocs" aria-label="Permalink to &quot;MkDocs&quot;">​</a></h1><p>决定同时使用 MdBook，应该尽量避免使用这里不通用的东西。</p><p>这里介绍一些 MkDocs 特有的格式。</p><p>更详细的请阅读 <a href="https://cyent.github.io/markdown-with-mkdocs-material/syntax/main/" target="_blank" rel="noreferrer">Cyent</a>。</p><h2 id="警告框" tabindex="-1">警告框 <a class="header-anchor" href="#警告框" aria-label="Permalink to &quot;警告框&quot;">​</a></h2><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">!!! warning &quot;警告&quot;</span></span>
